  ...
  return (
    props.status && (
      <div className="fixed w-full top-0 left-0 right-0 bottom-0 z-50 flex items-center justify-center bg-black bg-opacity-70">
        <div className="flex flex-col gap-10 justify-center items-center overflow-hidden w-[90%] lg:w-[35%] md:w-[60%] min-h-[80%] border-4 bg-[#17074E] border-lightPurple rounded-md p-6 text-white">
